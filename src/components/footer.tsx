...
const Footer = forwardRef<HTMLDivElement, IFooterProps>((props) => {
  ...
  const handleScrollToSection = (idSection: number) => {
    props.scrollToSection(idSection);
  };
    ...
    <div className="footer_page">
      <div className='contact_text_container'>
        ...
        <div className='contact_menu_container'>
          <div className='first_menu_container'>
            {firstMenu.map((item) => (
              <div key={item.id} onClick={() => handleScrollToSection(item.id)} className='container_menu_item'>
                {t(item.name)}
              </div>
            ))}
          </div>
        ...
        <div className='footer_buttons_container'>
          <button className='footer_mvp_button' onClick={props.handleOpenModal}>{t('Test_MVP')}</button>

          <div className='footer_social_icons'>
            <a href={telegramUrl} target="_blank" rel="noopener noreferrer">
              <img src={telegram} alt="Telegram" className='footer_icon' />
            </a>
